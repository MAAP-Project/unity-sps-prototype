...
variable "docker_images" {
  ...
  default = {
    ...
    hysds_ui              = "marjoluc/hysds_ui:latest"
    ...
    redis                 = "redis:latest"
    performance_estimator = "marjoluc/performance_estimator:latest"
  }
}
...
variable "service_port_map" {
  ...
  default = {
    ...
    "redis_service"                     = 6379
    "performance_estimator_service"     = 5000
...
variable "node_port_map" {
  ...
  default = {
    ...
    "grq2_es"                       = 30012
    "mozart_es"                     = 30013
    "performance_estimator_service" = 30014
  }
}
